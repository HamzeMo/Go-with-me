...
const handleYesClick = () => {
  ...
  gif.src = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcHJkZnFmNWtkbnM2OXdqNnA2cms4ODRxejk0dG1pdmJjdHFnZTBvNSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/BK1EfIsdkKZMY/giphy.gif";
  ...
  letsGoBtn.addEventListener("click", () => {
    ...
    alert(`I love You Fatooomy ${selectedDateIdea}`);
  });
